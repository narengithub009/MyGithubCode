...
<div id="selection"><input type="radio" name="type" id="Medical" checked="checked" onchange="formSelection(0);">&nbsp;Medical&nbsp;&nbsp;<input type="radio" name="type" id="Medical" onchange="formSelection(1);">&nbsp;General&nbsp;&nbsp;</div>
<div class="Medical">
<div class="wrapper"><form:form method="POST" action="javascript:addProduct(1,${createdby});" onsubmit="return doFormValidate();" commandName="command" id="ProductEntry" class="ProductEntry1">
		...
		<form:input path="pinvid" id="piid1" value="" readonly="true" hidden="true"/>
		
		

		
		<form:input path="category" id="category1" class="" value="Medical" readonly="true" hidden="true"/>
	
		<!-- <td><form:label path="shopid" >Shop Id</form:label></td> -->
		<form:input path="shopid" id="shopid" value="${createdby}" readonly="true" hidden="true"/>
	
	<div id="tab5">
		<!-- <td><form:label path="agencyid" >Agency Id</form:label></td> -->
		<form:input path="agencyid" id="agencyid1" value="" readonly="true" hidden="true"/>
	</div>
	<div id="tab6">
		<label><form:label path="" >Organization Name</form:label></label>
		<form:input path="" id=""  class=""  value="${organization}" readonly="true"/>
	</div>
	<div>

<label><form:label path="branchname" >Branch Name</form:label></label>
<form:select path="branchname">
	...
	<div id="tab6">
		...
		<form:input path="agencyname" id="agencyname1"  class="names"  value="" readonly="readonly"/>
	</div>
		...
		<form:input path="mfcompany" id="mfcompany1" value="" class="names" />
		</div>
	
		<div>
		<label><form:label path="schdrug" >SCH</form:label></label>
		<form:input path="schdrug" id="schdrug1" value=""/></div>
	
		<div>
		<label><form:label path="batchNo" >Batch No</form:label></label>
		<form:input path="batchNo" id="batchNo1" value="" onchange="validateBatchNo(1,${createdby})"/>
		</div>
	
		<div>
		<label><form:label path="subcategory" >Category</form:label></label>
		<form:select path="subcategory" id="subcategory1" ><form:options items="${categories}"/></form:select>
        </div>
	
	<div id="tab1">
		<label><form:label path="noofsheets" >No Of Sheets</form:label></label>
		<form:input path="noofsheets" class="integer" id="noofsheets1" value="" onchange="getPrice(1);" onblur="getSheetPrice(1);"/>
	</div>
	<div id="tab2">
		<label><form:label path="quantitypersheet" >Quantity Per Sheet</form:label></label>
		<form:input path="quantitypersheet" class="integer" id="quantitypersheet1" value="" onchange="getSheetPrice(1);"/>
	</div>
	<div id="tab3">
		<label><form:label path="pricepersheet" >Price Per Sheet</form:label></label>
		<form:input path="pricepersheet" id="pricepersheet1" class="double" value="" onchange="getPrice(1);"/>Rs.
	</div>

	
	 <div id="tab3">
		<label><form:label path="price" >Price</form:label></label>
		<form:input path="price" id="price1" value="" class="double"  readonly="true" hidden="" onfocus=""/>Rs.
		</div>
	
		<div id="tab4">
	    <label><form:label path="dlpricepersheet" >DL Sheet Price</form:label></label>
		<form:input path="dlpricepersheet" id="dlpp1" class="double"  value="" hidden="" onchange="getDlPrice(1);"/>Rs.
	</div>
	
	   <div>
		<label><form:label path="dlprice" >Dealer Price</form:label></label>
		<form:input path="dlprice" id="dlprice1" value="" class="double"  readonly="true" hidden="" onfocus=""/>
	</div>
	   
	    <div>
		<label><form:label path="quantity" >Quantity</form:label></label>
		<form:input path="quantity" class="integer" id="quantity1" value="" readonly="" hidden="" />
	</div>
	
	    <div>
		<label><form:label path="expirydate" >Expiry Date</form:label></label>
		<form:input path="expirydate" id="expirydate1" value=""  hidden="" maxlength="0" placeholder="YYYY-MM-DD"/>
	</div>
	
	<div class="submit ">
	<input type="submit" id="submit1" value="SAVE"/><input type="submit" id="update1" disabled="true" value="Update"/>
...
<div class="general">
<div class="wrapper">
<form:form method="POST" action="javascript:addProduct(0,${createdby});" commandName="command" id="ProductEntry" class="ProductEntry0">

	<div id="msg">${msg}</div>
	
      <form:input path="pid" id="pid0" value="" readonly="true" hidden="true" placeholder="pid"/>

	
		<form:input path="pinvid" id="piid0" value="" readonly="true" hidden="true" placeholder="piid"/>
  
         <form:input path="category" id="category0" value="General" readonly="true" hidden="true"  placeholder=""/></td>

		<form:input path="shopid" id="shopid0" value="${createdby}" readonly="true" hidden="true"/>
	
	
	<!-- <div id="tab7">
		<label><form:label path="agencyid" >Agency Id</form:label></label> -->
		<form:input path="agencyid" id="agencyid0" value="" readonly="true" hidden="true"/>
	<!--  </div>-->
   <div id="tab8">
		<label><form:label path="agencyname" >Agency Name</form:label></label>
		<form:input path="agencyname" class="names0" id="agencyname0" value="" readonly="readonly"/>
	</div>
	<div>
		<label><form:label path="pname" >Product Name</form:label></label>
		<form:input path="pname" class="names0" id="pname0" value=""/>
	</div>
	<div>
		<label><form:label path="mfcompany" >MFC</form:label></label>
		<form:input path="mfcompany" class="names0" id="mfcompany0" value=""/>
	</div>

	<div>
		<label><form:label path="batchNo" >Batch No</form:label></label>
		<form:input path="batchNo"  class="batchNo0" id="batchNo0" value="" onchange="validateGeneralProductBatchNo(0,${createdby})"/>
	</div>
	<div>
	    <label><form:label path="price" >Price</form:label></label>
		<form:input path="price" class="double0" id="price0" value="" readonly="" hidden=""/>Rs.
	</div> 
	<div>
	    <label><form:label path="quantity" >Quantity</form:label></label>
		<form:input path="quantity" class="integer0" id="quantity0" value="" readonly="" hidden=""/>
	</div> 

	<div>
	    <label><form:label path="dlprice" >Dealer Price</form:label></label>
		<form:input path="dlprice" class="double0" id="dlprice0" value="" readonly="" hidden=""/>Rs.
	</div>
	<div>
	    <label><form:label path="expirydate" >Expiry Date</form:label></label>
		<form:input path="expirydate" id="expirydate0" value=""  maxlength="0" placeholder="YYYY-MM-DD"/>
	</div> 
	<div >
	
	<input type="submit" id="submit0" value="SAVE"/><input type="submit" id="update0" disabled="true" value="Update"/>
