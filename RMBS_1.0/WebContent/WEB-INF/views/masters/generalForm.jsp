		...
		<div class="general">
			<div class="wrapper">
				<form:form method="POST"
					...
					<form:input path="pid" id="pid0" value="" readonly="true"
						hidden="true" placeholder="pid" />


					<form:input path="pinvid" id="piid0" value="" readonly="true"
						hidden="true" placeholder="piid" />

					<form:input path="category" id="category0" value="General"
						readonly="true" hidden="true" placeholder="" />
					</td>

					<form:input path="shopid" id="shopid0" value="${createdby}"
						readonly="true" hidden="true" />


					<!-- <div id="tab7">
		<label><form:label path="agencyid" >Agency Id</form:label></label> -->
					<form:input path="agencyid" id="agencyid0" value="" readonly="true"
						hidden="true" />
					<!--  </div>-->
					<div id="tab6">
					...
					<div id="tab8">
						...
						<form:input path="agencyname" class="names0" id="agencyname0"
					...
					<div>
						...
						<form:input path="mfcompany" class="names0" id="mfcompany0"
							value="" />
					</div>

					<div>
						<label><form:label path="batchNo">Batch No</form:label></label>
						<form:input path="batchNo" class="batchNo0" id="batchNo0" value=""
							onchange="validateGeneralProductBatchNo(0,${createdby})" />
					</div>
					<div>
					...
					<div>
						...
						<input type="submit" id="submit0" value="SAVE" /><input
							type="submit" id="update0" disabled="true" value="Update" />
