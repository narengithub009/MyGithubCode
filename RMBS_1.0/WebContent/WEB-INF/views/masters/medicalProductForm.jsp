 ...
 <!--Horizontal Tab-->
        <div id="horizontalTab">
            <ul class="resp-tabs-list">
                <li onclick=""><a href="productEntryForm.html?task_form_type=medical">Medical Products Entry Form</a></li>
                <li onclick=""><a href="productEntryForm.html?task_form_type=general">General Products Entry Form</a></li>
               
            </ul>
            <div class="resp-tabs-container">
                <div>
                   <p><jsp:include page="/WEB-INF/views/masters/medicalForm.jsp"></jsp:include></p>
 				</div>
                <div>
                  <p></p>
                </div>
