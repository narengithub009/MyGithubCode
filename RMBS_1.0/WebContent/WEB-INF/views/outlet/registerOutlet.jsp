...
//google.maps.event.addDomListener(window, 'load', initialize);
	...
	$( "#dob" ).datepicker({
       ...
       function addBranch()
       {
           ...
           $.ajax({    	   
       	   	type:"POST",
       	   	url:'validateOutletRegistration.html',
       	   	data:data,
...
<div class="wrapper">
<form:form method="POST" action="javascript:addBranch()"  commandName="command" id="registerform1" class='outletregistrastion'>
   ...
   <div>
	...
	<div  style="display: ;">
		...
		<form:input path="gender" id="sex" value="" readonly="true"/>
	</div>
	...
	<div>
		...
		<form:input path="resourceBean.addressBean.email" id="pmail" class="email" placeholder="abcd@gmial.com" />
	</div>
	</div>
	</div>
	<div>
