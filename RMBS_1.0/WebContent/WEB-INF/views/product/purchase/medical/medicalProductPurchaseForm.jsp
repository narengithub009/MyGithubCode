...
<body>
 ...
 <!--Horizontal Tab-->
        <div id="horizontalTab">
            ...
            <li onclick="loadMedicalPurchaseForm();" class="activemode" style="color: #fff;border-color: #3C873C;">Medical Products Purchase Form</li>
            <li ><a style="color: #3C873C;" href="openPurchaseEntryForm.html?task_type=sub&task_form_type=general">Move To General Products Purchase Form</a></li>
             
          </ul>
            <div class="resp-tabs-container">
                <div class="medical_form_container">
                   <p><jsp:include page="/WEB-INF/views/product/purchase/medical/medicalPurchaseForm.jsp"></jsp:include></p>
 				</div>
