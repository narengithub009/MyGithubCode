...
<form:form commandName="command" method="post"
   ...
   <div><form:input type="hidden"  path="id" id="id" value="${org.id}" readonly="true" /></div>			
	...
	<div>
		...
		<form:input path="firstName" class="names" id="fname" value="${org.firstName}" />
	</div>
	
    <div>
		<label><form:label path="lastName" >Last Name</form:label></label>
		<form:input path="lastName" class="names" id="lname"  value="${org.lastName}" />
	</div>
	<div>
		<label><form:label path="userName" >User Name</form:label></label>
		<form:input path="userName" id="uname" value="${org.userName}" readonly="true" onblur="return userid_validation(this,5,12);" />
	</div>
	...
	<div>
		...
		<form:input path="resourceBean.addressBean.email" id="pmail" class="email" placeholder="abcd@gmial.com" value="${org.resourceBean.addressBean.email}" />
	</div>
	...
	<div class="sname">
		...
		<form:input path="name" class="shopnames" id="sname" value="${org.name}" />
	</div>
    <div  class="tin">
