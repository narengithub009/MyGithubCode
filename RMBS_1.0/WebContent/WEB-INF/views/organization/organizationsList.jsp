...
<div style="height:20px;"></div>
     <c:out value="${userscount}"/>
        <div id="container" style="margin: auto;width:100%;">
            <div class="list">
            <h3 align="center" class="listcaption"> Organizations List</h3>
                <table  id="example" class="display" style="text-align: center;border-color: grey;" border="1">
                 ...
                 <tfoot class="listfooter"><tr><td  colspan="8" background="images/green.png">			
...
<script type="text/JavaScript">
    $(function(){
        $('.page_nav a').click(function(e) {
         alert($(this).text());
         location.replace('<%=request.getContextPath()%>/organizationsList.html?pg='+$(this).text());
        });
