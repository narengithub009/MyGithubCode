...
@Service
public class PurchaseReturnOrderListDwdService {
	...
	public void download(String user,String type, String token, HttpServletResponse response, PurchaseReturnOrderModel purchaseReturnOrderModel) {
		 
		try {
			// 1. Add report parameters
			HashMap<String, Object> params = new HashMap<String, Object>(); 
			params.put("Title", "Purchase Return Order List Reports");
			params.put("user", user);
			params.put("fromDate", DateAndTimeUtilities.getCurrentDate());
			params.put("toDate", DateAndTimeUtilities.getCurrentDate());		

			String fileName = "Purchase Return Order List Reports";
		...
		//	List<PurchaseOrderBean> list=reportsService.purchaseOrderListReports(branchId);
			List<PurchaseReturnOrderBean1> list=PurchaseReturnOrderBeanPreparation1.preparePurchaseReturnOrderBeanFromPurchaseReturnOrderModel1(purchaseReturnsService.getPurchaseReturnOrderList(purchaseReturnOrderModel));
