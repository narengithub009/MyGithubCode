...
public class PurchaseOrderDownloadService {
	...
	public void download(String user,String type, String token, HttpServletResponse response,Date fromDate,Date toDate,BranchModel branchModel) {
		...
		try {
			...
			params.put("Title", "Purchse Order Reports");
			params.put("fromDate", fromDate);
			params.put("toDate", toDate);
			params.put("user", user);
			
			String fileName = "Purchse Order Reports";
			...
			List<PurchaseOrderBean1> list=PurchaseOrderBeanPreparation1.prepareListOfPurchaseOrderBeanForReports1(reportsService.purchaseOrderReports(fromDate,toDate,branchModel));
