...
@Service
public class PurchaseRtnOrderLineitemsDwnService {
	public static final String TEMPLATE = "/purchaseReturnOrderLineitemsReports.jrxml";
	...
	public void download(String user,String type, String token, HttpServletResponse response, PurchaseReturnLineItemsModel purchaseReturnLineItemsModel) {
		 
		try {
			// 1. Add report parameters
			HashMap<String, Object> params = new HashMap<String, Object>(); 
			params.put("Title", "Purchase Return Order Lineitems List Reports");
			params.put("user", user);
			String fileName = "Purchase Return Order Lineitems List Reports";
		...
		//	List<PurchaseOrderBean> list=reportsService.purchaseOrderListReports(branchId);
			List<PurchaseReturnLineItemsBean1> list=PurchaseReturnLineItemsBeanPreparation1.prepareListOfPurchaseReturnLineitemBeans1(purchaseReturnsService.getPurchaseReturnLineItems(purchaseReturnLineItemsModel));
